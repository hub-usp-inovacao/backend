...
$majorToMinors = {
  ...
  'Comércio e Serviços' => [
    ...
    'Comércio Varejista', 'Alojamento e Alimentação', 'Informação e Comunicação',
  ...
  'Educação, Artes e Esportes' => ['Educação', 'Artes, Cultura, Esporte e Recreação'],
  'Saúde e Serviços Sociais' => ['Saúde Humana e Serviços Sociais'],
